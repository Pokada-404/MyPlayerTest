...
public class STO_CharacterParameter : ScriptableObject
{
    ...
    #endregion
    [Label("効果時間")]
    public float _blinkMaxTime = default;
    [Label("使用後のクールタイム")]
    public float _blinkReCastTime = default;
    [Label("速度倍率"), Range(1, 10)]
    public float _blinkMoveSpeedmagnification = 1;
    ...
    #endregion
    [Label("効果時間")]
    public float _OILMaxTime = default;
    [Label("使用後のクールタイム")]
    public float _OILReCastTime = default;
    [Label("速度倍率"), Range(1, 10)]
    public float _OILMoveSpeedMagnification = 1;
    [Label("攻撃力上昇倍率"), Range(1, 10)]
    public float _OILAttaclPowerMagnification = 1;
    [Label("アニメーション速度上昇倍率"), Range(1, 10)]
    public float _OILAnimationSpeedMagnification = 1;
}
